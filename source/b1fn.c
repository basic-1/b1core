...
{
#ifdef B1_FEATURE_FUNCTIONS_MATH_EXTRA
	{{{0x3608, B1_IDENT_FLAGS_SET_FN(0, 1)}, {0}, B1_TYPE_FP_HIGH_PREC}, b1_fn_bltin_pi},
#endif
#ifdef B1_FEATURE_FUNCTIONS_MATH_BASIC
	{{{0x77e61, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_ANY}, B1_TYPE_ANY}, b1_fn_bltin_abs},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STANDARD
	{{{0x780c6, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_STRING}, B1_TYPE_INT}, b1_fn_bltin_asc},
#endif
#ifdef B1_FEATURE_FUNCTIONS_MATH_EXTRA
	{{{0x780f6, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_FP_HIGH_PREC}, B1_TYPE_FP_HIGH_PREC}, b1_fn_bltin_atn},
#endif
#ifdef B1_FEATURE_FUNCTIONS_MATH_EXTRA
	{{{0x78af4, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_FP_HIGH_PREC}, B1_TYPE_FP_HIGH_PREC}, b1_fn_bltin_cos},
#endif
#ifdef B1_FEATURE_FUNCTIONS_MATH_EXTRA
	{{{0x796f0, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_FP_HIGH_PREC}, B1_TYPE_FP_HIGH_PREC}, b1_fn_bltin_exp},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STANDARD
	{{{0x7aa1f, B1_IDENT_FLAGS_SET_FN(3, 1)}, {B1_TYPE_BOOL, B1_TYPE_ANY, B1_TYPE_ANY}, B1_TYPE_ANY}, b1_fn_bltin_iif},
#endif
#ifdef B1_FEATURE_FUNCTIONS_MATH_BASIC
#ifdef B1_FRACTIONAL_TYPE_EXISTS
	{{{0x7aae6, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_FP_HIGH_PREC}, B1_TYPE_FP_HIGH_PREC}, b1_fn_bltin_int},
#endif
#endif
#ifdef B1_FEATURE_FUNCTIONS_STANDARD
	{{{0x7b99e, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_STRING}, B1_TYPE_INT}, b1_fn_bltin_len},
#endif
#ifdef B1_FEATURE_FUNCTIONS_MATH_EXTRA
	{{{0x7bb09, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_FP_HIGH_PREC}, B1_TYPE_FP_HIGH_PREC}, b1_fn_bltin_log},
#endif
#ifdef B1_FEATURE_FUNCTIONS_MATH_BASIC
#ifdef B1_FRACTIONAL_TYPE_EXISTS
	{{{0x7daf7, B1_IDENT_FLAGS_SET_FN(0, 1)}, {0}, B1_TYPE_FP_HIGH_PREC}, b1_fn_bltin_rnd},
#endif
#endif
#ifdef B1_FEATURE_FUNCTIONS_MATH_BASIC
	{{{0x7df57, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_ANY}, B1_TYPE_ANY}, b1_fn_bltin_sgn},
#endif
#ifdef B1_FEATURE_FUNCTIONS_MATH_EXTRA
	{{{0x7dfa1, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_FP_HIGH_PREC}, B1_TYPE_FP_HIGH_PREC}, b1_fn_bltin_sin},
#endif
#ifdef B1_FEATURE_FUNCTIONS_MATH_EXTRA
	{{{0x7e0cd, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_FP_HIGH_PREC}, B1_TYPE_FP_HIGH_PREC}, b1_fn_bltin_sqr},
#endif
#ifdef B1_FEATURE_FUNCTIONS_MATH_EXTRA
	{{{0x7e3d2, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_FP_HIGH_PREC}, B1_TYPE_FP_HIGH_PREC}, b1_fn_bltin_tan},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STANDARD
	{{{0x7ee82, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_STRING}, B1_TYPE_ANY}, b1_fn_bltin_val},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STANDARD
	{{{0x116efd4, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_INT}, B1_TYPE_STRING}, b1_fn_bltin_chr},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STANDARD
	{{{0x11b969f, B1_IDENT_FLAGS_SET_FN(3, 1)}, {B1_TYPE_BOOL, B1_TYPE_STRING, B1_TYPE_STRING}, B1_TYPE_STRING}, b1_fn_bltin_striif},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STRING
	{{{0x11eadc9, B1_IDENT_FLAGS_SET_FN(3, 1)}, {B1_TYPE_STRING, B1_TYPE_INT, B1_TYPE_ANY}, B1_TYPE_STRING}, b1_fn_bltin_mid},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STANDARD
	{{{0x1238dd0, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_ANY}, B1_TYPE_STRING}, b1_fn_bltin_str},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STRING
	{{{0x11bdac2d, B1_IDENT_FLAGS_SET_FN(2, 1)}, {B1_TYPE_STRING, B1_TYPE_INT}, B1_TYPE_STRING}, b1_fn_bltin_right},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STRING
	{{{0x1300c35d, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_STRING}, B1_TYPE_STRING}, b1_fn_bltin_rtrim},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STRING
	{{{0x1d73fc80, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_STRING}, B1_TYPE_STRING}, b1_fn_bltin_ucase},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STRING
	{{{0x2900f3d3, B1_IDENT_FLAGS_SET_FN(3, 1)}, {B1_TYPE_ANY, B1_TYPE_STRING, B1_TYPE_STRING}, B1_TYPE_INT}, b1_fn_bltin_instr},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STRING
	{{{0x294f840e, B1_IDENT_FLAGS_SET_FN(2, 1)}, {B1_TYPE_STRING, B1_TYPE_INT}, B1_TYPE_STRING}, b1_fn_bltin_left},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STRING
	{{{0x295a50cb, B1_IDENT_FLAGS_SET_FN(2, 1)}, {B1_TYPE_STRING, B1_TYPE_INT}, B1_TYPE_STRING}, b1_fn_bltin_lset},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STRING
	{{{0x2a05e671, B1_IDENT_FLAGS_SET_FN(2, 1)}, {B1_TYPE_STRING, B1_TYPE_INT}, B1_TYPE_STRING}, b1_fn_bltin_rset},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STRING
	{{{0xf8410b03, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_STRING}, B1_TYPE_STRING}, b1_fn_bltin_lcase},
#endif
#ifdef B1_FEATURE_FUNCTIONS_STRING
	{{{0xfa34225f, B1_IDENT_FLAGS_SET_FN(1, 1)}, {B1_TYPE_STRING}, B1_TYPE_STRING}, b1_fn_bltin_ltrim},
#endif
};
#else
static const B1_BLTIN_FN b1_fn_bltin[B1_FN_BLTIN_COUNT] =
